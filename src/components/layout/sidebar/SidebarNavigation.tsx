...
const SidebarNavigation: React.FC<SidebarNavigationProps> = ({ 
  ...
  const defaultSubMenuItems = {
    "Courses": [
      { name: "Overview", icon: <BarChart3 size={16} />, path: "/courses/overview" },
      { name: "Create Course", icon: <BookOpen size={16} />, path: "/courses/create" },
      { name: "Bundles", icon: <BookOpen size={16} />, path: "/courses/bundles" },
      { name: "Categories", icon: <BookOpen size={16} />, path: "/courses/categories" }
    ],
    "Leads": [
      { name: "All Leads", icon: <UserPlus size={16} />, path: "/leads/all" },
      { name: "Lead Forms", icon: <UserPlus size={16} />, path: "/leads/forms" },
    ...
    "Analytics": [
      { name: "Overview", icon: <BarChart3 size={16} />, path: "/analytics/overview" },
      { name: "Traffic", icon: <BarChart3 size={16} />, path: "/analytics/traffic" },
      { name: "Conversions", icon: <BarChart3 size={16} />, path: "/analytics/conversions" }
    ]
  };

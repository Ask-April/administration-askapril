      ...
      <DialogContent className="">
        ...
        <div className="space-y-4 pt-2">
          <div>
            ...
            <Input id="lesson-name" value={lessonName} onChange={e => setLessonName(e.target.value)} placeholder="Untitled lesson" className="mt-1.5" />
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-3 gap-3">
              {lessonTypes.map(type => <Button key={type.id} type="button" variant="outline" className={`h-auto flex-col py-3 ${selectedType === type.id ? 'border-primary bg-primary/10' : ''}`} onClick={() => setSelectedType(type.id)}>
